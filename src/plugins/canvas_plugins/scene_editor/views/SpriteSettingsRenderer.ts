...
import { SpriteViewControllers } from "./SpriteViewControllers";

export class SpriteSettingsRenderer implements IRenderer<UI_Layout> {
    private controller: SpriteViewControllers;

    constructor(controller: SpriteViewControllers) {
