...
export const DeleteAssetControl: PropControl<any> = {
...
export const EnterEditModeControl: PropControl<any> = {
    click(context, element) {
        const asset = context.registry.stores.assetStore.getAssetById(( <UI_InputElement> element).listItemId);
...
export const AssetNameControl: PropControl<any> = {
    change(val, context) {
        context.updateTempVal(val);
        context.registry.services.render.reRender(UI_Region.Dialog);
    },
...
export const AssetPathControl: PropControl<any> = {
    change(val, context) {
        context.updateTempVal(val);
        context.registry.services.render.reRender(UI_Region.Dialog);
    },
...
export const SaveEditControl: PropControl<any> = {
    click(context) {
        const editedAsset = (<AssetManagerDialogPlugin> this.plugin).editedAsset;
