...
export const ButtonComp = (props: UI_ComponentProps<UI_Button>) => {
    ...
    return (
        <ButtonStyled className="ce-button" style={style} {...props} onClick={() => props.element.paramController ? props.element.paramController.click(null, null) : props.element.click(props.registry)}>
            {props.element.label}
