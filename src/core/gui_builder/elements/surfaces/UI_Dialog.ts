...
import { GlobalControllerProps } from '../../../controllers/AbstractController';
...
export class UI_Dialog extends UI_Layout {
    ...
    close(): void {
        this.plugin.getControllerById(this.controllerId).click(GlobalControllerProps.CloseDialog);
    }
}