...
import { AnimationSettings, AnimationSettingsProps } from '../../../plugins/scene_editor/settings/AnimationSettings';
import { SettingsRowStyled, LabelColumnStyled, FieldColumnStyled } from '../../../plugins/scene_editor/settings/SettingsComponent';
