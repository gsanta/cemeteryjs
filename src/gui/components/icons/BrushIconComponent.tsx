...
import { IconProps, IconComponent } from './Icon';

const BackgroundComponent = styled.path`
...
export function BrushIconComponent(props: IconProps) {

    return (
        <IconComponent viewBox="0 0 24 24" onClick={props.onClick}>
            <BackgroundComponent isActive={props.isActive} d="M0 0h24v24H0V0z"/>
