...
import {IconForgroundStyled, IconBackgroundStyled, IconStyled} from './Icon';

export function ClearIconComponent(props: {onClick: () => void}) {
    return (
        <IconStyled  height="24" viewBox="0 0 24 24" width="24" onClick={props.onClick} disabled={false}>
