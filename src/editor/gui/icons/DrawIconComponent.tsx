...
export function DrawIconComponent(props: IconProps) {
    ...
    return (
        <IconStyled viewBox="0 0 24 24" onClick={props.onClick}>
            <IconBackgroundStyled isActive={props.isActive} d="M0 0h24v24H0V0z"/>
