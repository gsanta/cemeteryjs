...
export class HelperMeshes {
    ...
    private showWorldAxis(size) {
        ...
        axisX.translate(new Vector3(-100, 0, -100), 1, Space.WORLD);
        
        var xChar = makeTextPlane("X", "red", size / 10);
        xChar.position = new Vector3(0.9 * size, -0.05 * size, 0);
        xChar.translate(new Vector3(-100, 0, -100), 1, Space.WORLD);
        ...
        axisY.translate(new Vector3(-100, 0, -100), 1, Space.WORLD);

        var yChar = makeTextPlane("Y", "green", size / 10);
        yChar.position = new Vector3(0, 0.9 * size, -0.05 * size);
        yChar.translate(new Vector3(-100, 0, -100), 1, Space.WORLD);
        ...
        axisZ.translate(new Vector3(-100, 0, -100), 1, Space.WORLD);
        
        var zChar = makeTextPlane("Z", "blue", size / 10);
        zChar.position = new Vector3(0, 0.05 * size, 0.9 * size);
        zChar.translate(new Vector3(-100, 0, -100), 1, Space.WORLD);
    };
}