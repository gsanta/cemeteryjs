...
import { NodePortShape } from "./NodePortShape";
import { NodeShape } from "./NodeShape";
import { AbstractShape, ShapeFactoryAdapter, ShapeJson } from './AbstractShape';
...
export class NodeConnectionShape extends AbstractShape {
    ...
    fromJson(json: NodeConnectionShapeJson, registry: Registry) {
        ...
        const nodeView1 = (<NodeShape> registry.data.node.items.getById(json.joinPoint1.nodeId));
        const nodeView2 = (<NodeShape> registry.data.node.items.getById(json.joinPoint2.nodeId))
