...
export class LightPropertiesRenderer implements IRenderer<UI_Layout> {
    private controller: LightPropertiesController;

    constructor(controller: LightPropertiesController) {
