...
it ('Move a canvas item', () => {
    ...
    expect(canvasItem.dimensions).toBeEqualDimensions(new Polygon([new Point(5, 5), new Point(5, 14), new Point(24, 14), new Point(24, 5)]));

    const center = canvasItem.dimensions.getBoundingCenter();
    drag(controllers, center, center.addX(100).addY(50));

    expect(canvasItem.dimensions).toBeEqualDimensions(new Polygon([new Point(15, 10), new Point(15, 19), new Point(34, 19), new Point(34, 10)]));
});