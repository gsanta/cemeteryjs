...
it ('Add new pixels based on their canvas position', () => {
    ...
    bitmapEditor.pixelController.addPixel(new Point(5, 5), 'wall');
    ...
    bitmapEditor.pixelController.addPixel(new Point(10, 9), 'door');
    ...
    bitmapEditor.pixelController.addPixel(new Point(10, 10), 'window');
    ...
    bitmapEditor.pixelController.addPixel(new Point(31, 15), 'bed');
